...
from kuegi_bot.utils.trading_classes import Bar, parse_utc_timestamp
from .coinbase_websocket import CoinbaseWebsocket
from ..ExchangeWithWS import ExchangeWithWS


class CoinbaseInterface(ExchangeWithWS):
    ...
    def __init__(self, settings, logger, on_tick_callback=None, on_api_error=None):
        ...
        hosts = ["wss://ws-feed.pro.coinbase.com"]  # no testnet on spot
        super().__init__(settings, logger,
                         ws=CoinbaseWebsocket(wsURLs=hosts,
