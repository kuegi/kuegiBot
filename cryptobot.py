        ...
        for stratId in strategies.keys():
            ...
            if stratId == "strategyOne":
                strat = StrategyOne(# Strategy One
                                    ...
                                    short_entry_2_std_fac=stratSettings.STD_FAC_OVERBOUGHT,
                                    short_entry_2_std_fac_entry=stratSettings.STD_FAC_LOST_OVERBOUGHT,
                                    short_entry_2_max_natr=stratSettings.SHORT_ENTRY_2_MAX_NATR,
                                    short_entry_3_max_natr=stratSettings.ENTRY_3_MAX_NATR,
                                    # long entries
                                    ...
                                    days_buffer_ranging=stratSettings.DAYS_BUFFER_RANGING,
